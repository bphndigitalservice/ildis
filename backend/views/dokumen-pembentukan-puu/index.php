...
<div style="display: none;">
    <form action="<?php echo Url::toRoute('/dokumen-pembentukan-puu/cetak') ?>" method="POST" target="_blank" id="myform">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'filter' => ArrayHelper::map(DocumentType::findByGroup(DocumentGroup::LEGISLATION_FORMATION), 'name', 'name'),
