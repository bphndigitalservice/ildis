...
<div class="nav-tabs-custom">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" id="tab_2">
            <?= $this->render('../monografi/teu/_teu', ['teu' => $teu, 'id' => $model->id]) ?>
        </div>
        <div class="tab-pane" id="tab_3">
            <?= $this->render('../monografi/subyek/_subyek', ['subyek' => $subyek, 'id' => $model->id]) ?>
        </div>

        <div class="tab-pane" id="tab_4">
            <?= $this->render('../monografi/lampiran/_lampiran', ['lampiran' => $lampiran, 'id' => $model->id]) ?>
        </div>

        <div class="tab-pane" id="tab_5">
            <?= $this->render('../monografi/eksemplar/_eksemplar', ['eksemplar' => $eksemplar, 'id' => $model->id]) ?>
        </div>
    </div>
