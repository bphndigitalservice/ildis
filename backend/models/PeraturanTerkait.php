...
class PeraturanTerkait extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'status_perter' => 'Status Peraturan Terkait',
            'catatan_perter' => 'Catatan Peraturan Terkait',
            'integrasi' => 'Integrasi',
    ...
    {
        return $this->hasOne(Peraturan::className(), ['id' => 'peraturan_terkait']);
    }

    public function getJudul($id)
    {
        $peraturan = Peraturan::findOne($id);
        return  $peraturan->singkatan_jenis . '-' . $peraturan->nomor_peraturan;
