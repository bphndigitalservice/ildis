...
/**
 * This is the model class for table "log_pustakawan".
 *
 * @property int $id
 ...
 */
class LogPustakawan extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['controller', 'aksi', 'created_by', 'updated_by'], 'string', 'max' => 255],
        ];
    }
