...
class DokumenTerkait extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['id_dokumen', 'integrasi', 'urutan', 'id_dokumen_terkait'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'id_dokumen_terkait' => 'ID Dokumen Terkait',
            'document_terkait' => 'Dokumen Terkait',
            'status_docter' => 'Status Dokumen Terkait',
            'catatan_docter' => 'Catatan Dokumen Terkait',
            'integrasi' => 'Integrasi',
            'urutan' => 'Urutan',
